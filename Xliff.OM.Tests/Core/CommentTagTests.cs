namespace Localization.Xliff.OM.Core.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="CommentTag"/> class.
    /// </summary>
    [TestClass()]
    public class CommentTagTests
    {
        /// <summary>
        /// The element under test.
        /// </summary>
        private CommentTag element;
        ...
        [TestMethod()]
        public void CommentTag_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 1; i++)
            {
        ...
        [TestCategory(TestUtilities.UnitTestCategory)]
        [TestMethod()]
        public void CommentTag_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestCategory(TestUtilities.UnitTestCategory)]
        [TestMethod()]
        public void CommentTag_IXliffDataProvider_GetXliffText()
        {
