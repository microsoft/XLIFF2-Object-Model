namespace Localization.Xliff.OM.Core.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="Group"/> class.
    /// </summary>
    [TestClass()]
    public class GroupTests
    {
        ...
        public void Group_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Group_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Group_IXliffDataProvider_GetXliffText()
        {
