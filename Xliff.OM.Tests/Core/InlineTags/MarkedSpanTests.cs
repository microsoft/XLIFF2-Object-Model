namespace Localization.Xliff.OM.Core.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="MarkedSpan"/> class.
    /// </summary>
    [TestClass()]
    public class MarkedSpanTests
    {
        /// <summary>
        /// The element under test.
        /// </summary>
        private MarkedSpan _element;
        ...
        #region Test Methods
        /// <summary>
        /// Tests the default values for <see cref="MarkedSpan"/>.
        /// </summary>
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void MarkedSpan_Defaults()
        {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void MarkedSpan_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void MarkedSpan_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void MarkedSpan_IXliffDataProvider_GetXliffText()
        {
