namespace Localization.Xliff.OM.Core.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="SpanningCodeEnd"/> class.
    /// </summary>
    [TestClass()]
    public class SpanningCodeEndTests
    {
        /// <summary>
        /// The element under test.
        /// </summary>
        private SpanningCodeEnd _element;
        ...
        #region Test Methods
        /// <summary>
        /// Tests the default values for <see cref="SpanningCodeEnd"/>.
        /// </summary>
        [TestMethod()]
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void SpanningCodeEnd_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                Assert.AreEqual(20, attributes.Count(), "Number of attributes is incorrect.");
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void SpanningCodeEnd_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void SpanningCodeEnd_IXliffDataProvider_GetXliffText()
        {
