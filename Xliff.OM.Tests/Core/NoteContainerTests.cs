namespace Localization.Xliff.OM.Core.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="NoteContainer"/> class.
    /// </summary>
    [TestClass()]
    public class NoteContainerTests
    {
        /// <summary>
        /// The element under test.
        /// </summary>
        private NoteContainer _element;
        ...
        {
            this._element = new NoteContainer();
        ...
        public void NoteContainer_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 1; i++)
            {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void NoteContainer_IXliffDataProvider_GetXliffChildren()
        {
            ...
            TestUtilities.VerifyItems(this._element.Notes, children, ElementNames.Note);
        }
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void NoteContainer_IXliffDataProvider_GetXliffText()
        {
