namespace Localization.Xliff.OM.Core.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="ProcessingInstructionTag"/> class.
    /// </summary>
    [TestClass()]
    public class ProcessingInstructionTagTests
    {
        /// <summary>
        /// The element under test.
        /// </summary>
        private ProcessingInstructionTag element;
        ...
        [TestMethod()]
        public void ProcessingInstructionTag_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 1; i++)
            {
        ...
        [TestCategory(TestUtilities.UnitTestCategory)]
        [TestMethod()]
        public void ProcessingInstructionTag_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestCategory(TestUtilities.UnitTestCategory)]
        [TestMethod()]
        public void ProcessingInstructionTag_IXliffDataProvider_GetXliffText()
        {
