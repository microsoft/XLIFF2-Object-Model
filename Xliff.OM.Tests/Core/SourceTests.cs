namespace Localization.Xliff.OM.Core.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="Source"/> class.
    /// </summary>
    [TestClass()]
    public class SourceTests
    {
        ...
        public void Source_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Source_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod()]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Source_IXliffDataProvider_GetXliffText()
        {
