namespace Localization.Xliff.OM.Modules.Glossary.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="Definition"/> class.
    /// </summary>
    [TestClass]
    public class DefinitionTests
    {
        ...
        public void Definition_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Definition_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Definition_IXliffDataProvider_GetXliffText()
        {
