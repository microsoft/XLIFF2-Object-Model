namespace Localization.Xliff.OM.Modules.Glossary.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="Translation"/> class.
    /// </summary>
    [TestClass]
    public class TranslationTests
    {
        ...
        public void Translation_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Translation_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void Translation_IXliffDataProvider_GetXliffText()
        {
