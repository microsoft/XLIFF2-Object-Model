namespace Localization.Xliff.OM.Modules.ResourceData.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="ResourceItemSource"/> class.
    /// </summary>
    [TestClass]
    public class ResourceItemSourceTests
    {
        /// <summary>
        /// The element under test.
        /// </summary>
        private ResourceItemSource element;
        ...
        public void ResourceItemSource_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void ResourceItemSource_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void ResourceItemSource_IXliffDataProvider_GetXliffText()
        {
