namespace Localization.Xliff.OM.Modules.ResourceData.Tests
{
    ...
    /// <summary>
    /// This class tests the <see cref="ResourceItemTarget"/> class.
    /// </summary>
    [TestClass]
    public class ResourceItemTargetTests
    {
        /// <summary>
        /// The element under test.
        /// </summary>
        private ResourceItemTarget element;
        ...
        public void ResourceItemTarget_IXliffDataProvider_GetXliffAttributes()
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void ResourceItemTarget_IXliffDataProvider_GetXliffChildren()
        {
        ...
        [TestMethod]
        [TestCategory(TestUtilities.UnitTestCategory)]
        public void ResourceItemTarget_IXliffDataProvider_GetXliffText()
        {
